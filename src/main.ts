...
document.getElementById('pedirCarta')?.addEventListener('click', () => {
...
function mostrarCarta(carta: number): void {
    const img = document.getElementById('cartaImagen') as HTMLImageElement;
...
const botonCartaSiguiente = document.getElementById('cartaSiguiente') as HTMLButtonElement;
...
function deshabilitarJuego(): void {
    const botonPedir = document.getElementById('pedirCarta') as HTMLButtonElement;
...
document.getElementById('cartaSiguiente')?.addEventListener('click',() => {
